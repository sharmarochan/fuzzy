...
rule1 = ctrl.Rule(hip['high'] | knee['low'] | time['low'] | stage['SLR'] , phase['P-LR'])
rule2 = ctrl.Rule(knee['low'] | time['low'] | stage['SMS'] , phase['P-MSS'])
rule3 = ctrl.Rule(hip['low'] | knee['low'] | time['low'] | stage['SMS'] , phase['P-MSS'])
rule4 = ctrl.Rule(hip['extension'] | knee['medium'] | time['medium'] | stage['SSS'] , phase['P-TSS'])
rule5 = ctrl.Rule(hip['extension'] | ~knee['low'] | time['medium'] | stage['SSS'] , phase['P-PSW'])
rule6 = ctrl.Rule(hip['low'] | ~knee['low'] | time['medium'] | stage['SSS'] , phase['P-IS'])
rule7 = ctrl.Rule(hip['high'] | knee['high'] | time['high'] | stage['SSS'] , phase['PMSW'])
rule8 = ctrl.Rule(hip['high'] | knee['low'] | time['high'] | stage['SSS'] , phase['PTSW'])
